...
LoginTest
    ...
    sleep       2s
    #for verification, In the screen we should see different images when we navigate
    Page Should Contain Image       //body/div[@id='contcont']/div[1]/div[2]/div[1]/div[5]/div[1]/a[1]/img[1]
    sleep       2s